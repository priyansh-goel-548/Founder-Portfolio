(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 68329, (e, t, r) => {
    "use strict";
    ...
    let n = e.r(67309)._(e.r(61835)).default.createContext({})
}, 31388, (e, t, r) => {
    "use strict";
    Object.defineProperty(r, "__esModule", {
        value: !0
    ...
    let n = "u" < typeof window ? e.r(59952).workAsyncStorage : void 0;
    ...
    i.ab = "/ROOT/yashil-patel-portfolio/node_modules/next/dist/compiled/process/", t.exports = i(229)
}, 74016, (e, t, r) => {
    "use strict";
    var n, o;
    t.exports = (null == (n = e.g.process) ? void 0 : n.env) && "object" == typeof(null == (o = e.g.process) ? void 0 : o.env) ? e.g.process : e.r(82979)
}, 65330, (e, t, r) => {
    "use strict";
    ...
    function H(e, t, r) {
        ...
        return ! function e(t, r, n, u, s) {
            ...
            if (p) return s = s(t), p = "" === u ? "." + k(t, 0) : u, T(s) ? (n = "", null != p && (n = p.replace(C, "$&/") + "/"), e(s, r, n, "", function(e) {
                return e
            })) : null != s && (A(s) && (c = s, a = n + (null == s.key || t && t.key === s.key ? "" : ("" + s.key).replace(C, "$&/") + "/") + p, s = P(c.type, a, c.props)), r.push(s)), 1;
            p = 0;
            var d = "" === u ? "." : u + ":";
            if (T(t))
                for (var g = 0; g < t.length; g++) f = d + k(u = t[g], g), p += e(u, r, n, f, s);
            else if ("function" == typeof(g = null === (l = t) || "object" != typeof l ? null : "function" == typeof(l = _ && l[_] || l["@@iterator"]) ? l : null))
                for (t = g.call(t), g = 0; !(u = t.next()).done;) f = d + k(u = u.value, g++), p += e(u, r, n, f, s);
            else if ("object" === f) {
    ...
    function L(e) {
        var t = R.T,
            r = {};
        r.types = null !== t ? t.types : null, R.T = r;
        try {
            var n = e(),
                o = R.S;
            null !== o && o(r, n), "object" == typeof n && null !== n && "function" == typeof n.then && n.then(w, I)
        } catch (e) {
            I(e)
        } finally {
    ...
    }, r.Component = S, r.Fragment = u, r.Profiler = c, r.PureComponent = E, r.StrictMode = s, r.Suspense = p, r.ViewTransition = h, r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = R, r.__COMPILER_RUNTIME = {
        __proto__: null,
        c: function(e) {
            return R.H.useMemoCache(e)
        }
    }, r.addTransitionType = D, r.cache = function(e) {
        return function() {
